...
class RobotGazeboEnv(gym.Env):
    ...
    def step_drone(self, action):
        ...
        self.cumulated_episode_reward += reward[0]
    ...
    def _reset_sim(self):
        ...
        if self.reset_controls :
            ...
            while not tmp :
                ...
                self.gazebo.unpauseSim()
                rospy.sleep(2.5)
                tmp = self._check_all_systems_ready() # when takeoff fails
                self.gazebo.pauseSim()
    ...
    def _check_all_systems_ready(self, arg):
        """
