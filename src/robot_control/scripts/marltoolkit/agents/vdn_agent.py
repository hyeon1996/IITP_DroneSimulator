...
# sys.path.append('/home/mlic/drones/GazeboPX4MARL/src/robot_control/scripts')

from src.robot_control.scripts.marltoolkit.utils import (LinearDecayScheduler, MultiStepScheduler,
...
class VDNAgent(BaseAgent):
    ...
    def predict(self, obs, available_actions):
        ...
        # print(f"vdn_agent predict actions: {actions}")
        return actions
