...
class MultiAgentEnv:
    ...
    def set_gazebo_env(self):
        ...
        for i in range(self.n_agents):
            ...
            gz_cmd_args = "PX4_SYS_AUTOSTART=4001 PX4_GZ_MODEL_POSE=" + pos + " PX4_SIM_MODEL=gz_x500 ./build/px4_sitl_default/bin/px4 -i " + id
    ...
    def get_reward(self, obs):
        ...
        goal_reward = 5 if goal_check else 0
        ...
        collison_reward = -5 if collison_check else 0
